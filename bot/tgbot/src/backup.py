...
def text(update, context):
    ...
    update.message.reply_text("What's your text, mate ?")
...
#https://api.telegram.org/1501983165:AAEmpF5g_LWfjuRLf_Md9ez_qLRzSHK1tw8
...
def main():
    ...
    updater = Updater("1501983165:AAEmpF5g_LWfjuRLf_Md9ez_qLRzSHK1tw8", use_context=True)
